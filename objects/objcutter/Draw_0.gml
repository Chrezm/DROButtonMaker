...
if keyboard_check(vk_control) {
	var _guide_color = (current_second % 2 == 0) ? c_black : c_white;
	draw_line_color(x+floor(width/2 - 0.1), y, x+floor(width/2 - 0.1), y+height, _guide_color, _guide_color);
	draw_line_color(x-1, y+floor(height/2 - 0.1), x+width, y+floor(height/2 - 0.1), _guide_color, _guide_color);
	draw_line_color(x+floor(width/2), y, x+floor(width/2), y+height, _guide_color, _guide_color);
	draw_line_color(x-1, y+floor(height/2), x+width, y+floor(height/2), _guide_color, _guide_color);
}
